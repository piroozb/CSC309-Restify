...
const SearchResult = (props) => {
    ...
    return <>
        ...
        <header className="py-5">
            <div className="container px-2 px-lg-5 my-5">
                <div className="text-center">
                    <h1 className="display-4 fw-bolder" style={{ color: "black", marginTop: "70px" }}>Showing {resultCount} search results</h1>
        ...
        <section className="" style={{ paddingBottom: "100px" }}>
            <div className="container px-2 px-lg-5 mt-2">
                            ...
                            <div className="card h-100 carousel slide" id="property" data-bs-ride="carousel"
                                ...
                                <div className="card-body p-4">
                                    <div className="text-center">
                                        ...
                                        <p>{obj.number_of_bedroom} bedrooms</p>
                                        <p>{obj.number_of_washroom} washrooms</p>
                                        <p>{obj.number_of_guests} guests</p>
                                        {/* <!-- Product reviews--> */}
                ...
                {/* <div style={{ textAlign: "center", fontSize: "xx-large" }}>
                    <a style={{ padding: "10px" }} className={`${previous ? 'text-primary' : 'text-secondary'}`} onClick={loadPrevious}><Icon.ArrowLeftSquare /></a>
                    <a style={{ padding: "10px" }} className={`${next ? 'text-primary' : 'text-secondary'}`} onClick={loadNext}><Icon.ArrowRightSquare /></a>
                </div> */}
            </div>
        </section>
        {/* <!-- Bootstrap core JS--> */}
